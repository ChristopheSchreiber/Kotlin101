...
Internal visibility means your class in only visible in your module (Maven/Gradle module, project...).
...
You have to explictly declare that you are overriding a method.
----
...
=== Using when to check values on standard objects
----
...
----
fun isSmallList(list : List<String, maxSize : Int)
return when {
        list.isEmpty() -> "Empty !"
